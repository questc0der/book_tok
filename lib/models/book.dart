...
List<Book> books = [
  Book(
    ...
    """ 1. Embrace negative emotions and experiences Who you are is defined by what youre willing to struggle for.

Negative emotions are normal. Our cultures obsession with positivity and happiness has led to a fear of negative emotions. However, these emotions are not only natural but also necessary for growth and self-improvement. Embracing negative experiences allows us to:
...
Prioritize your fucks. We have limited emotional energy, so its crucial to be selective about what we care about. This concept involves:

Identifying your core values
Aligning your actions with those values
Letting go of trivial concerns
The art of not giving a fuck. This doesnt mean being indifferent to everything, but rather:
...
3. You are not special, and thats okay
The vast majority of your life will be boring and not noteworthy, and thats okay.
e of failure but the willingness to fail and learn from it.
